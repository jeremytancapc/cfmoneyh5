 ...
 * A fixed floating copy sits at the bottom of the viewport and hides
 * once the anchor scrolls into view (same pattern as the loan-results sticky CTA).
 */
export function AxsBackButton() {
  ...
  return (
    <>
      ...
      {/* Floating copy — visible while anchor is off-screen */}
      {!anchorVisible && (
        <div
